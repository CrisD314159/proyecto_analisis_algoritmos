...
from services.algorithms.execution_time_plotter import ExecutionTimePlotter
...
class AlgorithmsExecution:
    ...
    def run_radix_nodes(arr):
        ...
        try:
            ...
            print("Error executing the Radix Nodes Sort algorithm (Index out of range)")
            return -1
    ...
    def execute_algorithms(arr, plotter_name):
        ...
        file_path = plotter.plot_execution_times(plotter_name)
        return file_path
